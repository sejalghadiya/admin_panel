                      ...
                      if (productProvider.furnitureList.isNotEmpty)
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Product Category:--${productProvider.furnitureList[0].category}",
                            ),
                            Text(
                              "User product deleted:--${productProvider.furnitureList[0].isDeleted}",
                            ),
                          ],
                        ),
                    ],
                          ...
                          base64Images.add(base64Image);
                              ...
                              Map<String, dynamic> body = {
                                ...
                                "subProductType": productProvider
                                    ...
                                    .subProductType,
                                "categories":
                                    productProvider.furnitureList[0].category,
