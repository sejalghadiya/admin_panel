                          ...
                          children: [
                            Text(
                              productProvider.petList.isNotEmpty &&
                                  ...
                                  ? DateFormat(
                                      ...
                                      DateTime.parse(
                                        productProvider.petList[0].timestamps,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  productProvider.petList[0].user.fName.last
                                      .toString(),
                                ),
                                const SizedBox(width: 5),
                                Text(
                                  productProvider.petList[0].user.lName.last
                                      .toString(),
                                ),
                              ],
                            ),
                            Text(
                              "Product Category:--${productProvider.petList[0].category}",
                            ),
                            Text(
                              "User product deleted:--${productProvider.petList[0].isDeleted}",
                            ),
                          ],
                        ),
                    ],
                            ...
                            onPressed: () async {
                              ...
                              Map<String, dynamic> body = {
                                ...
                                "productType":
                                    productProvider.petList[0].productType,
                                "subProductType":
                                    productProvider.petList[0].subProductType,
                                "categories":
                                    productProvider.petList[0].category,
