...
class _JobDetailsScreenState extends State<JobDetailsScreen> {
  ...
  List<String> selectedPositionTypes = [
    "Temporary",
    "Contract",
    "Part Time",
    "Full Time",
  ...
  void setData() async {
    ...
    if (productProvider.jobList.isNotEmpty) {
      ...
      selectedSalaryType = productProvider.jobList[0].salaryPeriod.last
          .toString();
      _salaryFroController.text = productProvider.jobList[0].salaryFrom.last
          .toString();
      _salaryToController.text = productProvider.jobList[0].salaryTo.last
          .toString();
      _adTitleController.text = productProvider.jobList[0].adTitle.last
          .toString();
      _additionalInfoController.text = productProvider
          .jobList[0]
          .description
          .last
          .toString();
                            ...
                            children: [
                              Text(
                                productProvider.jobList.isNotEmpty &&
                                    ...
                                    ? DateFormat(
                                        ...
                                        DateTime.parse(
                                          productProvider.jobList[0].timestamps,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    productProvider.jobList[0].user.fName.last
                                        .toString(),
                                  ),
                                  const SizedBox(width: 5),
                                  Text(
                                    productProvider.jobList[0].user.lName.last
                                        .toString(),
                                  ),
                                ],
                              ),
                              Text(
                                "Product Category:--${productProvider.jobList[0].category}",
                              ),
                              Text(
                                "User product deleted:--${productProvider.jobList[0].isDeleted}",
                              ),
                            ],
                          ),
                      ],
                                ...
                                if (productProvider.jobList.isNotEmpty) ...[
                                  Text(
                                    ListFormatter.formatList(
                                      productProvider.jobList[0].price,
                                    ),
                                    style: TextStyle(
                                      fontSize: 15,
                                      color: Colors.black,
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                ...
                                Map<String, dynamic> body = {
                                  ...
                                  "positionType": selectedPositionalType
                                      .toString(),
                                  "salaryPeriod": selectedSalaryType.toString(),
                                  "productType":
                                      productProvider.jobList[0].productType,
                                  "subProductType":
                                      productProvider.jobList[0].subProductType,
                                  "categories":
                                      productProvider.jobList[0].category,
