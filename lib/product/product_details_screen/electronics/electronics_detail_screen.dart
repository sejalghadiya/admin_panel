...
class ElectronicsDetailsScreen extends StatefulWidget {
  ...
  @override
  State<ElectronicsDetailsScreen> createState() => _ElectronicsDetailsScreenState();
}
...
class _ElectronicsDetailsScreenState extends State<ElectronicsDetailsScreen> {
  ...
  void setData()async{
    ...
    setState(() {
      _priceController.text = productProvider.electronicsList[0].price.last.toString();
      _adTitleController.text = productProvider.electronicsList[0].adTitle.last.toString();
      _descriptionController.text = productProvider.electronicsList[0].description.last.toString();
            ...
            onPressed: () async {
              if (productProvider.electronicsList.isNotEmpty) {
                Map<String, dynamic> body = {
                  ...
                  "productType" : productProvider.electronicsList[0].productType,
                };
                      ...
                      if (productProvider.electronicsList.isNotEmpty)
                        Column(
                          ...
                          children: [
                            Text(
                              productProvider.electronicsList.isNotEmpty &&
                                  productProvider.electronicsList[0].timestamps.isNotEmpty
                                  ? DateFormat('d MMMM yyyy, hh:mm:ss a').format(
                                DateTime.parse(productProvider.electronicsList[0].timestamps).toLocal(), // Convert to local time
                              )
                                  : 'N/A',
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(productProvider.electronicsList[0].user.fName.last.toString()),
                                const SizedBox(width: 5),
                                Text(productProvider.electronicsList[0].user.lName.last.toString()),
                              ],
                            ),
                            Text("Product Category:--${productProvider.electronicsList[0].category}"),
                            Text("User product deleted:--${productProvider.electronicsList[0].isDeleted}"),
                          ],
                        ),
                    ],
                  ),
                                      ...
                                      Stack(
                                        children: [
                                          Container(
                                            ...
                                            child: productProvider.electronicsList.isNotEmpty &&
                                                productProvider.electronicsList[0].images.isNotEmpty &&
                                                selectedIndex < productProvider.electronicsList[0].images.length &&
                                                productProvider.electronicsList[0].images[selectedIndex].isNotEmpty
                                                ? Image.network(
                                    ...
                                    if (productProvider.electronicsList.isNotEmpty) ...[
                                      SizedBox(
                                        ...
                                        child: ListView.builder(
                                          ...
                                          itemCount:
                                          productProvider.electronicsList[0].images.length,
                                          shrinkWrap: true,
                                          itemBuilder: (context, index) {
                                            bool isSelected = index == selectedIndex;
                                            final imageUrl =
                                            productProvider.electronicsList[0].images[index];
                            ...
                            children: [
                              ...
                              if(productProvider.electronicsList.isNotEmpty)...[
                                if(isEditable)...[
                                  ...
                                  Text(ListFormatter.formatList(productProvider.electronicsList[0].adTitle),
                                ...
                                if(isEditable)...[
                                  ...
                                  Column(
                                    ...
                                    children: [
                                     ...
                                     Text(ListFormatter.formatList(productProvider.electronicsList[0].description),
                                          style: TextStyle(fontSize: 15)),
                                    ],
                                  )
                                ]
                      ...
                      onPressed: () async {
                       ...
                       /* List<String> filteredImagePaths = _selectedImages
                        ...
                        Map<String,dynamic> body = {
                          ...
                          "productType": productProvider.electronicsList[0].productType,
                          "subProductType": productProvider.electronicsList[0].subProductType,
                          "categories": productProvider.electronicsList[0].category,
