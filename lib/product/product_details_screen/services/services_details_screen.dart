                            ...
                            if (productProvider.servicesList.isNotEmpty)
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "Product Category:--${productProvider.servicesList[0].category}",
                                  ),
                                  Text(
                                    "User product deleted:--${productProvider.servicesList[0].isDeleted}",
                                  ),
                                ],
                              ),
                          ],
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    if (productProvider
                                        ...
                                        .isNotEmpty) ...[
                                      Text(
                                        'Service/Job:--  ${productProvider.servicesList[0].serviceJob}',
                                ...
                                child: ElevatedButton(
                                  onPressed: () async {
                                    ...
                                    Map<String, dynamic> body = {
                                      ...
                                      "service_type": _addServiceOrJobType.text
                                          .trim(),
                                      "description":
