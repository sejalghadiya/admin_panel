...
class BookSportsHobbyDetailsScreen extends StatefulWidget {
  ...
  @override
  State<BookSportsHobbyDetailsScreen> createState() => _BookSportsHobbyDetailsScreenState();
}

class _BookSportsHobbyDetailsScreenState extends State<BookSportsHobbyDetailsScreen> {
  ...
  void initState() {
    ...
    Future.microtask(() async {
     ...
     await productDetailsProvider.fetchProductDetails(productId, modelName);
      _priceController.text = productDetailsProvider.bookList[0].price.last.toString();
      _adTitleController.text = productDetailsProvider.bookList[0].adTitle.last.toString();
      _descriptionController.text = productDetailsProvider.bookList[0].description.last.toString();
    });
  }
                        ...
                        if (productProvider.bookList.isNotEmpty)
                          Column(
                            ...
                            children: [
                              Text(
                                productProvider.bookList.isNotEmpty &&
                                    productProvider.bookList[0].timestamps.isNotEmpty
                                    ? DateFormat('d MMMM yyyy, hh:mm:ss a').format(
                                  DateTime.parse(productProvider.bookList[0].timestamps).toLocal(), // Convert to local time
                                )
                                    : 'N/A',
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(productProvider.bookList[0].user.fName.last.toString()),
                                  const SizedBox(width: 5),
                                  Text(productProvider.bookList[0].user.lName.last.toString()),
                                ],
                              ),
                              Text("Product Category:--${productProvider.bookList[0].category}"),
                              Text("User product deleted:--${productProvider.bookList[0].isDeleted}"),
                            ],
                          ),
                      ],
                    ),
                                      ...
                                      Stack(
                                        children: [
                                          Container(
                                            ...
                                            child: productProvider.bookList.isNotEmpty &&
                                                productProvider.bookList[0].images.isNotEmpty &&
                                                selectedIndex < productProvider.bookList[0].images.length &&
                                                productProvider.bookList[0].images[selectedIndex].isNotEmpty
                                                ? Image.network(
                                     ...
                                     if (productProvider.bookList.isNotEmpty) ...[
                                       SizedBox(
                                         ...
                                         child: ListView.builder(
                                           ...
                                           itemCount:
                                           productProvider.bookList[0].images.length,
                                           shrinkWrap: true,
                                           itemBuilder: (context, index) {
                                             bool isSelected = index == selectedIndex;
                                             final imageUrl =
                                             productProvider.bookList[0].images[index];
                                         ...
                                         child: ElevatedButton(
                                           onPressed:!isEditable?null: () async {
                                             ...
                                             Map<String,dynamic> body = {
                                               ...
                                               "modelName": modelName,
                                               "images": productProvider.bookList[0].images,
                                               "productType": productProvider.bookList[0].productType,
                                               "subProductType": productProvider.bookList[0].subProductType,
                                               "categories": productProvider.bookList[0].category,
